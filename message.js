...
function buildHandshake(torrent) {
    ...
    // peer id
    console.log('gen',util.genId());
    buf.write(util.genId().toString());
    return buf;
}
...
export default { parse, buildBitfield, buildCancel, buildChoke, buildHandshake, buildHave, buildInterested, buildKeepAlive, buildPiece, buildPort, buildRequest, buildUnchoke, buildUninterested }